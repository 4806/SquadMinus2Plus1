...
indexHandler.searchHandler = function( ) {
    // webix.ajax().post("/search", $$("searchbox").getValue(), {
    //     error:indexHandler.errorHandler,
    //     success:function(dataString){ }
    // });
};

indexHandler.errorHandler = function() {
    ...
    webix.ui({
        rows:[
            { view:"toolbar", elements: [
                    ...
                    {view:"text", id:"searchbox", label:"Search Pages", align:"right", labelWidth:100, width:300},
            ...
            {template:indexHandler.strings.aboutText, css:"label_indexNorm", align:"center", autoheight:true, borderless:true},
            { height:50 },
            {view:"label", label:'<img src="img/flame_blue.png" height="100%"/> About The Team', css:"label_big", align:"center"},
            {template:indexHandler.strings.aboutTheTeam, css:"label_indexNorm", align:"center", autoheight:true, borderless:true},
            { height:50 },
            { cols:[
                { },
                {view:"button", value:"Sign Up Now!", align:"center", click:indexHandler.signupHandler},
                { }
            ]},
            { },
