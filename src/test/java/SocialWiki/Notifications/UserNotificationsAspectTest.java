...
public class UserNotificationsAspectTest {
    ...
    public void setUp() throws Exception {
        user1 = userRepo.save(new User("testUserName1", "testFirstName1", "testLastName1", "testEmail1@email.com", "testPassword1"));
        user2 = userRepo.save(new User("testUserName2", "testFirstName2", "testLastName2", "testEmail2@email.com", "testPassword2"));
        user3 = userRepo.save(new User("testUserName3", "testFirstName3", "testLastName3", "testEmail3@email.com", "testPassword3"));
